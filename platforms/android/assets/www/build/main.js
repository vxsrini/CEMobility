...
var Summary = (function () {
    function Summary(navCtrl, navParams, http) {
        ...
        this.http.get('http://vxsrini-laptop:3000/invoke').map(function (res) { return res.json(); }).subscribe(function (data) {
        ...
        this._db = new __WEBPACK_IMPORTED_MODULE_8_pouchdb__["a" /* default */]('birthdays.db', { adapter: 'cordova-sqlite' });
    }
    ...
    Summary = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular_navigation_nav_controller__["a" /* NavController */], __WEBPACK_IMPORTED_MODULE_2_ionic_angular_navigation_nav_params__["a" /* NavParams */], __WEBPACK_IMPORTED_MODULE_4__angular_http__["a" /* Http */]])
    ], Summary);
    return Summary;
}());
